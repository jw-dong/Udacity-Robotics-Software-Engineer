...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/jiawei/udacity_ws/src/main)
  set(main_DEVEL_PREFIX /home/jiawei/udacity_ws/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/jiawei/udacity_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jiawei/udacity_ws/src/main/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT main_NUM_DUMMY_TARGETS)
      set(main_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::main::wrapped-linker-option${main_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR main_NUM_DUMMY_TARGETS "${main_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::main::wrapped-linker-option${main_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND main_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jiawei/udacity_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${main_dep}_FOUND)
      find_package(${main_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${main_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
